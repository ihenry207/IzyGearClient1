  ...
  return(
    <>
      ...
      <div className="edit-listing">
        <h1 ref={topRef}>Edit Your Gear</h1>
        <form onSubmit={HandleUpdate}>
          <div className="edit-listing_step1">
            <h2>Step 1: Edit your gear information</h2>
            <hr />
            <h3>Category (Not Editable)</h3>
            ...
            {category === "Snowboard" && (
              <>
                ...
                <div className={`option ${withBoots ? 'selected' : ''}`}>
                    <input
                    type="checkbox"
                    id="withBoots"
                    checked={withBoots}
                ...
                <div className={`option ${withBindings ? 'selected' : ''}`}>
                    <input
                    type="checkbox"
                    id="withBindings"
    ...
    {subcategory && (
      <>
        ...
        {(subcategory === "Sleeping bags" || subcategory === "Outdoor clothing") && (
          ...
          <div className="edit-listing_step2">
